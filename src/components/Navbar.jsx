...
const Navbar = () => {
  ...
  return (
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 opacity-80 bg-primary brightness-125`}>
          ...
          {navLinks.map((link) => (
            <li
              ...
              className={`${active === link.title
                ...
                : "text-secondary"
                } hover:text-white transition-all duration-150 text-[18px] font-medium cursor-pointer`
              }
